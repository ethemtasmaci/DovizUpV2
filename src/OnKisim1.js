    ...
    <>
      ...
      <View
        ...
        <Text
          ...
          Döviz Kuru Hesaplama Kolaylığı
        </Text>
        ...
        <Text
          ...
          Basit ve hızlı döviz kuru hesaplama aracı ile döviz işlemleriniz hiç
          olmadığı kadar kolay. Anlık verilerle döviz kurlarını takip edin ve
          hesaplamalarınızı zahmetsizce yapın.
        </Text>
        ...
        <View
          ...
          <TouchableOpacity onPress={() => handleMenuPress('OnKisim2')}>
